...
<section class="page-section page-section-basic-page section-visible">
    ...
    <section class="page-section-bp ">
        ...
        <div class="section-content section-basic">
            <div class="container">
                <div class="article-content">
    ...
    <section class="page-section-bp even">

        <div class="section-content section-video-embed">
            <div class="container">
    ...
    <section class="page-section-bp ">
        ...
        <div class="section-content section-fullwidth-image">
            <div class="container">
                <figure>
