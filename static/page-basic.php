...
<section class="hero-basic-page with-image">
    <div class="container-fullwidth">
        <div class="hero-content">
            <h1 class="basic-page-main-title">
        ...
        <div class="main-content-container">
            <div class="bp-section section-basic-content">
                <div class="container article-content">
                    <h2>
                        Childhood Education and Care” contributes to the development of relevant policies and programs in Switzerland and other European countries. The foundation is seeking dialogue with decision-makers and society at large and helps to drive the research agenda by forming strategic partnerships.
                    </h2>
                    <p class="lead-text">
            ...
            <div class="bp-section section-video-embed">
                <div class="container">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/vEuW81Y8gm0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                    </div>
